        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 ">
          ...
          <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1">
            ...
            <p className="text-sm">
              ...
              vitae praesentium mollitia placeat consectetur sit dolorum ducimus
              dignissimos,
            </p>
            <div>
          ...
          <div className="order-1 sm:order-2  min-h-[450px] sm:min-h--[450px] flex justify-center items-center relative">
            {/* main image section */}
            <div className="flx justify-center items-center h-[300px] sm:h-[450px] overflow-hidden">
              <img
                src={imageId}
                alt=""
            ...
            {/* image list section */}
            <div className="flex lg:flex-col lg:top-1/2 lg:-translate-y-1/2 lg:py-2 justify-center gap-4 absolute bottom-[0px] lg:right-7 bg-white/30 rounded-full ">
              {ImageList.map((item) => (
                <img
                  key={item.id}
                  src={item.img}
